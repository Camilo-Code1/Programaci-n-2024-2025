...
public static Boolean validaEmail (String correo) {
    ...
    public static boolean validarMovilER(String telefono) {
        Pattern pattern = Pattern.compile("^[679]\\d{8}$", Pattern.CASE_INSENSITIVE);        
        ...
        public static String formatearNombre(String nombre) {
            ...
            StringBuilder nombreFor = new StringBuilder();
    
            for (String palabra : palabras) {
                if (!palabra.isEmpty()) {
                    nombreFor.append(Character.toUpperCase(palabra.charAt(0)))
                        .append(palabra.substring(1))
                        .append(" ");
                }
            }
    
            return nombreFor.toString().trim(); 
        }
